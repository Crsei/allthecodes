...
| `AccountAuthLoginStart` | `POST` | `/api/account-auth/login/start` | `JsonValue` | `JsonValue` | `concurrent` | - | - |
| `AccountAuthLoginComplete` | `POST` | `/api/account-auth/login/complete` | `JsonValue` | `JsonValue` | `concurrent` | - | - |
| `AccountAuthStatus` | `GET` | `/api/account-auth/status` | - | `JsonValue` | `concurrent` | - | - |
| `AccountAuthRefresh` | `POST` | `/api/account-auth/refresh` | - | `JsonValue` | `concurrent` | - | - |
| `AccountAuthLogout` | `POST` | `/api/account-auth/logout` | - | `JsonValue` | `concurrent` | - | - |
| `AccountAuthBilling` | `GET` | `/api/account-auth/billing` | - | `JsonValue` | `concurrent` | - | - |
| `AccountAuthBillingLedger` | `GET` | `/api/account-auth/billing/ledger` | - | `JsonValue` | `concurrent` | - | - |
| `AccountAuthBillingOrder` | `GET` | `/api/account-auth/billing/orders/{id}` | - | `JsonValue` | `concurrent` | - | - |
