...
// ClientRequest::MemoryDreamList - legacy REST handler, MemoryProcessor target.
// ClientRequest::MemoryDreamDetail - legacy REST handler, MemoryProcessor target.
// ClientRequest::MemoryProposalList - legacy REST handler, MemoryProcessor target.
// ClientRequest::MemoryProposalDetail - legacy REST handler, MemoryProcessor target.
// ClientRequest::MemoryProposalApprove - legacy REST handler, MemoryProcessor target.
// ClientRequest::MemoryProposalReject - legacy REST handler, MemoryProcessor target.
