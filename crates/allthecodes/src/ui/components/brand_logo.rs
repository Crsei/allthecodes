...
const WORD: [Glyph; 11] = [
    ...
    Glyph {
        rows: [0b110000, 0b110000, 0b110000, 0b110000, 0b110000, 0b111111],
    },
    Glyph {
        rows: [0b110000, 0b110000, 0b110000, 0b110000, 0b110000, 0b111111],
    },
    Glyph {
        rows: [0b111111, 0b001100, 0b001100, 0b001100, 0b001100, 0b001100],
    },
    Glyph {
        rows: [0b110011, 0b110011, 0b111111, 0b111111, 0b110011, 0b110011],
    },
    Glyph {
        rows: [0b000000, 0b111111, 0b110000, 0b111110, 0b110000, 0b111111],
    },
    Glyph {
        rows: [0b001111, 0b010000, 0b100000, 0b100000, 0b010000, 0b001111],
    },
    Glyph {
        rows: [0b001100, 0b011110, 0b110011, 0b110011, 0b011110, 0b001100],
    },
    Glyph {
        rows: [0b111100, 0b100010, 0b100010, 0b100010, 0b100010, 0b111100],
    },
    Glyph {
        rows: [0b000000, 0b111111, 0b110000, 0b111110, 0b110000, 0b111111],
    },
    Glyph {
        rows: [0b111111, 0b100000, 0b111000, 0b000111, 0b000001, 0b111111],
    },
];
