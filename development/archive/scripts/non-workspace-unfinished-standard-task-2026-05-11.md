...
- Generic selectable command surface:
  ...
  and `development/archive/plan/generic-selectable-command-surface-plan-2026-05-08.md`.
...
6. Update only the docs needed to record current effects, defects,
   verification, and remaining risks. Use `development/archive/KNOWN_ISSUES.md` only for
