...
> 来源: `development/reference/anthropic/what's_changed.md` (共~83个版本发布)
...
**实现建议**: 参考 `development/reference/anthropic/what's_changed.md` v2.1.154 中 Workflow 设计。核心组件：
...
- [Claude Code 近两月完整变更记录](development/reference/anthropic/what's_changed.md)
- [allthecodes 缺失工具更新适配计划](development/archive/plan/missing-tools-adaptation-plan-2026-05-28.md)
- [bash-shell-parity-migration-plan-2026-05-18.md](development/archive/plan/bash-shell-parity-migration-plan-2026-05-18.md)
- [cc-engine-migration-plan-2026-05-13.md](development/archive/plan/cc-engine-migration-plan-2026-05-13.md)
