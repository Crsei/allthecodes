...
- 第三方或内部的 “coding plan” 部署，通过 `ANTHROPIC_BASE_URL` 暴露 Anthropic 兼容的 Messages API 形态，并使用 token 式鉴权，类似于 `development/reference/anthropic_coding.md`。
...
- `development/reference/anthropic/api/overview.md`
- `development/reference/anthropic/prompt_cache/overview.md`
- `development/reference/anthropic_coding.md`
...
- 更新：
  ...
  - `development/archive/COMMAND_REFERENCE.md`
