...
> 已完成模块: [`COMPLETED_FULL.md`](../COMPLETED_FULL.md) (完整实现) | [`COMPLETED_SIMPLIFIED.md`](../COMPLETED_SIMPLIFIED.md) (进入全量构建后视作待补齐清单)
...
- **文件数**: 204 个 .rs 文件, 22 个顶级子目录
- **代码行数**: ~49,187 行 (占 TS 的 ~22%)
- **测试数**: 819 个测试
- **工具数**: 30 工具 + MCP 动态工具
- **命令数**: 74 个斜杠命令
