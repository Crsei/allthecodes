...
范围: 根据 [`development/archive/COMMAND_UI_REFERENCE.md`](../COMMAND_UI_REFERENCE.md) 审计 Rust
...
6. 实现完成后再更新 `development/archive/COMMAND_UI_REFERENCE.md`，不要提前把计划写成事实。
...
```powershell
git diff -- development/archive/plan/command-settings-ui-coverage-audit-2026-05-08.md
```
