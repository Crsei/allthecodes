...
- Known broad-test risk: `development/archive/KNOWN_ISSUES.md` TEST-002 says package-wide `cargo test -p claude-code-rs` has unrelated/cross-test-state failures; use focused baselines for this checkpoint unless the package-wide issue is being fixed.
